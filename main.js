...
// inline live validation for book tittle
...
// book tittle error function
function showBookTittleError() {
  if (bookTitleInput.validity.valueMissing) {
    titleError.textContent = "You need to enter a book tittle!";
  }
  titleError.className = "error active";
}

// inline live validation for book author
bookAuthorInput.addEventListener("input", (event) => {
  if (bookAuthorInput.validity.valid) {
